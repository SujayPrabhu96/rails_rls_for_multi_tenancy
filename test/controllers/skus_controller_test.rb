...
class SkusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sku" do
    assert_difference("Sku.count") do
      post skus_url, params: { sku: { description: @sku.description, name: @sku.name, tenant_id: @sku.tenant_id } }
    end
  ...
  test "should update sku" do
    patch sku_url(@sku), params: { sku: { description: @sku.description, name: @sku.name, tenant_id: @sku.tenant_id } }
